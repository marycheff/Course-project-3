...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 23 2024 г., 22:05
...
CREATE TABLE `rentals` (
  ...
  `rental_date` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Структура таблицы `rental_history`
--
...
CREATE TABLE `reservations` (
  ...
  `reservation_date` varchar(255) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Индексы таблицы `rental_history`
--
...
--
-- AUTO_INCREMENT для таблицы `rental_history`
--
ALTER TABLE `rental_history`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
-- Ограничения внешнего ключа таблицы `rental_history`
--
ALTER TABLE `rental_history`
  ADD CONSTRAINT `rental_history_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `rental_history_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`);
